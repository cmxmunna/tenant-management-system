<?php 
    ...
    include "../tenant_controller/uploadTenantMetroRegCopyCntrl.php" ;
        ...
        <input type="button" onclick="goBack()" class="link-hvr" value="← Back">
            <form method="post" action="" enctype="multipart/form-data">
                <div class="top-mar-50">
                    <h1><legend>UPLOAD TENANT METRO REG. COPY</legend></h1>
                    <table>
                        <tr>
                            <td colspan="2"><img  src="../resources/img/tenant_img/contractScanCopy/<?php echo $tenant['tenant_reg_img'] ?>" alt="<?php echo $tenant['tenant_reg_img'] ?>" height="200px"></td>
                        </tr>
                        <tr>
