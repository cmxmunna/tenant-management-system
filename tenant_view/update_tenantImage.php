<?php 
    ...
    include "../tenant_controller/update_tenantImageCntrl.php" ;
        ...
        <input type="button" onclick="goBack()" class="link-hvr" value="← Back">
            <form method="post" action="" enctype="multipart/form-data">
                <div class="top-mar-50">
                    ...
                    <table>
                        <tr>
                            <td colspan="2"><img  src="../resources/img/tenant_img/<?php echo $tenant['image'] ?>" alt="<?php echo $tenant['image'] ?>" height="200px"></td>
                        </tr>
                        <tr>
